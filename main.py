        ...
        if proccessed_frame % Config.skip_rate == 0:
            ...
            if app_mode == "face":
                ...
                for face in faces:
                    ...
                    embedding = get_embedding(img, face)
                    ...
                    for name in known_people.keys():
                        ...
                        cos_distance = findCosineDistance(
                            embedding, known_people[name])

                        if (
                            min_cos_distance > cos_distance
                            and cos_distance <= Config.cos_distance_threshold
                        ):
                ...
                rimg = app.draw_on(
                    img, faces, names, cos_distances, age_cathegories, emotions
                )
